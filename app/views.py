...
def home(request):
  ...
  if is_authenticated:
    return render(request, "app/home.html", { "title": "Home", "sidenav": settings.SIDENAV, "is_authenticated": is_authenticated })
  else:
    return render(request, "app/home_external.html", { "title": "Home" })
